...
def GetEmptyMarker(marker):
    if marker == rt.kFullTriangleUp:
        return rt.kOpenTriangleUp
    if marker == rt.kFullCircle:
        return rt.kOpenCircle
    if marker == rt.kFullSquare:
        return rt.kOpenSquare
    if marker == rt.kFullTriangleDown:
        return rt.kOpenTriangleDown
    if marker == rt.kFullCross:
        return rt.kOpenCross
    if marker == rt.kFullDiamond:
        return rt.kOpenDiamond
